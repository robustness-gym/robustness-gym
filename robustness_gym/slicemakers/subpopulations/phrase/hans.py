...
from robustness_gym.slicemakers.subpopulations.phrase.phrase import HasAnyPhrase


class HansAllPhrases(Subpopulation):
    ...
    def __init__(self,
        ...
        super(HansAllPhrases, self).__init__(
            identifiers=[
                Identifier(name='SingularNouns'),
                Identifier(name='PluralNouns'),
                Identifier(name='TransitiveVerbs'),
                Identifier(name='PassiveVerbs'),
                Identifier(name='IntransitiveVerbs'),
                Identifier(name='NPSVerbs'),
                Identifier(name='NPZVerbs'),
                Identifier(name='PluralNPZVerbs'),
                Identifier(name='Prepositions'),
                Identifier(name='Conjs'),
                Identifier(name='PastParticiples'),
                Identifier(name='UnderstoodArgumentVerbs'),
                Identifier(name='NonEntQuotVerbs'),
                Identifier(name='QuestionEmbeddingVerbs'),
                Identifier(name='CalledObjects'),
                Identifier(name='ToldObjects'),
                Identifier(name='FoodWords'),
                Identifier(name='LocationNounsA'),
                Identifier(name='LocationNounsB'),
                Identifier(name='WonObjects'),
                Identifier(name='ReadWroteObjects'),
                Identifier(name='Adjectives'),
                Identifier(name='AdjectivesCompNonEnt'),
                Identifier(name='AdjectivesCompEnt'),
                Identifier(name='Adverbs'),
                Identifier(name='ConstAdv'),
                Identifier(name='ConstQuotEntailed'),
                Identifier(name='Relations'),
                Identifier(name='Questions'),
                Identifier(name='NonEntComplementNouns'),
                Identifier(name='EntComplementNouns'),
                Identifier(name='AdvsNonEntailed'),
                Identifier(name='AdvsEntailed'),
            ],
            *args,
            **kwargs
        )
    ...
    def apply(self,
              ...
              *args,
              **kwargs) -> np.ndarray:
        # Each slice corresponds to a separate SliceMaker
        for i in range(slice_membership.shape[1]):
            # Fill out the slice_membership
            slice_membership[:, i:i + 1] = self.subpopulations[i].apply(
