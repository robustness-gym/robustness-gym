...
def mandoline(D_src, D_tgt, edge_list, sigma=None):
    """
    Mandoline solver.
    Args:
...
def estimate_performance(D_src, D_tgt, edge_list, empirical_mat_list_src):
    ...
    for mat_src in empirical_mat_list_src:
        ...
        all_estimates.append(
            SimpleNamespace(weighted=weighted_estimates, source=source_estimates)
        )

    return SimpleNamespace(all_estimates=all_estimates, solved=solved, weights=weights)
